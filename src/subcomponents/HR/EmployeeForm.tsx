...
/**
* @description EmployeeForm component for adding or editing employee details.
* It allows HR to enter employee information such as name, role, email, and password.
* @component
* @example  
* return (
*   <EmployeeForm
...
* @property {any} userToEdit - Optional user object to pre-fill the form for editing. 
* 
* @param {any} {
  onClose,
  onSubmit,
...
const EmployeeForm: React.FC<EmployeeFormProps> = ({ onClose, onSubmit, userToEdit = null, }) => {
